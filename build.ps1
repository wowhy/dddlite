...
dotnet build .\src\DDDLite.CQRS.Store -c Release
dotnet build .\src\DDDLite.CQRS.Messaging -c Release
...
dotnet pack .\src\DDDLite.CQRS.Store -c Release -o ..\..\artifacts --version-suffix=preview-$env:APPVEYOR_BUILD_NUMBER
dotnet pack .\src\DDDLite.CQRS.Messaging -c Release -o ..\..\artifacts --version-suffix=preview-$env:APPVEYOR_BUILD_NUMBER
